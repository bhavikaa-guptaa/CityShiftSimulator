...
const SimsMode = ({ isOpen, onClose, gender, city, cityVibe, routine }) => {
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 relative flex flex-col lg:flex-row">
          ...
          <div className="absolute top-10 left-10 max-w-sm pointer-events-none">
            ...
            >
              ...
              <p className="text-xl font-light italic">
                {currentScene === 'morning' ? routine[0] : currentScene === 'work' ? routine[1] : routine[routine.length - 1]}
              </p>
            </motion.div>
          </div>
        </div>
        ...
        <div className="w-full lg:w-96 bg-midnight-900/50 backdrop-blur-xl border-l border-white/10 p-8 flex flex-col gap-8">
          <div>
...
<div className="space-y-2 md:col-span-2">
  ...
  <input type="color" className="w-full h-10 rounded-xl border border-white/10 bg-white/5" value={formData.hairColor} onChange={e => setFormData({ ...formData, hairColor: e.target.value })} />
</div>
<div className="space-y-2 md:col-span-2">
  <label className="text-xs font-display tracking-widest text-slate-500 uppercase">Skin Color</label>
  <input type="color" className="w-full h-10 rounded-xl border border-white/10 bg-white/5" value={formData.skinColor} onChange={e => setFormData({ ...formData, skinColor: e.target.value })} />
</div>
<div className="space-y-2 md:col-span-2">
  <label className="text-xs font-display tracking-widest text-slate-500 uppercase">Family Members</label>
     <input type="number" min="0" className="w-full bg-white/5 border border-white/10 rounded-xl py-4 pl-4 pr-12 focus:ring-2 ring-accent-blue/50 outline-none transition-all" placeholder="Number of family members" value={formData.familyCount} onChange={e => setFormData({ ...formData, familyCount: parseInt(e.target.value, 10) || 0 })} />
</div>
<div className="space-y-2 md:col-span-2">
  <label className="text-xs font-display tracking-widest text-slate-500 uppercase">Family Tags (comma separated)</label>
  <input type="text" className="w-full bg-white/5 border border-white/10 rounded-xl py-4 pl-12 pr-4 focus:ring-2 ring-accent-blue/50 outline-none transition-all" placeholder="e.g., sports, cooking" value={formData.familyTags} onChange={e => setFormData({ ...formData, familyTags: e.target.value })} />
</div>
                ...
                <div className="lg:col-span-8">
                  <ErrorBoundary>
                    <AvatarRoom 
                      ...
                      cityVibe={
                        formData.destinationCity.toLowerCase().includes('tokyo') ? 'tokyo' : 
                        formData.destinationCity.toLowerCase().includes('angeles') ? 'la' :
                        formData.destinationCity.toLowerCase().includes('london') ? 'london' : 'default'
                      } 
                      hairColor={formData.hairColor}
                      skinColor={formData.skinColor}
                      familyCount={formData.familyCount}
